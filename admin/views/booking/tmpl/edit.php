...
?>
<form action="<?php echo JRoute::_('index.php?option=com_u3abooking&view=booking&layout=edit' . $tmpl . '&id=' . (int) $this->item->id); ?>"
    ...
    <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'details', JText::_('COM_U3ABOOKING_BOOKING_DETAILS')); ?>
